...
class SpamAnalyzer extends KeywordAnalyzer implements TextAnalyzer {
    private String[] keywords; //слова-спам
...
public class TextAnalyzerApp {
    ...
    public Label checkLabels(TextAnalyzer[] analyzers, String text) {
        for (TextAnalyzer comment : analyzers) {
            Label label = comment.processText(text);
            if (label != Label.OK)
                return label;
        }
        return Label.OK;
    ...
    public static void main(String[] args) {
        ...
        TextAnalyzerApp testObject = new TextAnalyzerApp();

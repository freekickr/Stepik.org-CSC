...
/*
Дан класс ComplexNumber. Переопределите в нем методы equals() и hashCode() так, чтобы equals() сравнивал экземпляры ComplexNumber
...
public final class ComplexNumber {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getRe(), this.getRe()) == 0 &&
                Double.compare(that.getIm(), this.getIm()) == 0;
    }
